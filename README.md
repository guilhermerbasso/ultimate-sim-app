...
- **Authenticated local OBS certification target** with a loopback dashboard Browser Source, separate
  password-challenged operator WebSocket, capability allowlists, health freshness, manual override,
  serialized lifecycle, and strict IPv4/IPv6 loopback endpoint validation.
