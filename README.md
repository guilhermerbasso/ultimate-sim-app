...
Release line: **Ultimate Sim App 2.57.0** · [Latest published Windows x64 downloads](https://github.com/guilhermerbasso/ultimate-sim-app/releases/latest)
...
### 2.57.0 — * feat(dashboard): add RaceCon RC-01 Apex Strike by @guilhermerbasso in https://github.com

See the [v2.57.0 release notes](https://github.com/guilhermerbasso/ultimate-sim-app/releases/tag/v2.57.0) for the full list.
