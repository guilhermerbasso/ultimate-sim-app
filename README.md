...
### 2.55.0 — Durable Stint History & Evidence-Grounded Setup Guidance
...
See the [v2.55.0 release notes](https://github.com/guilhermerbasso/ultimate-sim-app/releases/tag/v2.55.0) for the full list.
