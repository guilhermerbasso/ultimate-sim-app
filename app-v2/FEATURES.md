...
- **Steward Desk** — casos locais com atores/roles definidos no processo main, clips vinculados à identidade imutável da sessão de captura, evidence locks content-addressed, regras versionadas, veredito humano, dissenso/recurso e exportação anonimizada por schema allowlist. Pacotes v2 carregam a chain canônica verificada; imports aplicam as mesmas invariantes de veredito, são staged até `import-completed` e respeitam bloqueios de reexportação de direitos de terceiros. A chain continua **unanchored** sem âncora externa; o app nunca aplica penalidade automática.
