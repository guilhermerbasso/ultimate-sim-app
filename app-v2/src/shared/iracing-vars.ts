...
export const IRACING_VARIABLES: IracingVarDef[] = [
  ...
  { id: 'WaterLevel', label: 'Water level', unit: 'L', category: 'car' },
  { id: 'Lapge', label: 'Voltage', unit: 'V', category: 'car' },
  ...
  { id: 'PitchRate', label: 'Pitch rate', unit: 'rad/s', category: 'car' },
  { id: 'Roll', label: 'Roll', unit: 'rad', category: 'car' },
  { id: 'RollRate', label: 'Roll rate', unit: 'rad/s', category: 'car' },
  ...
  { id: 'SteeringWheelAngleMax', label: 'Max steering wheel angle', unit: '?', category: 'inputs' },
  ...
  { id: 'LapDeltaToOptimalLap', label: 'Delta to optimal lap', unit: 's', category: 'timing' },
  { id: 'LapDeltaToSessionOptimalLap', label: 'Delta to session optimal', unit: 's', category: 'timing' },
  { id: 'LapDeltaToDriverBestLap', label: 'Delta to driver best', unit: 's', category: 'timing' },
  ...
  { id: 'FuelLevelPct', label: 'Fuel in tank', unit: '%', category: 'fuel' },
  ...
  { id: 'FuelPress', label: 'Fuel pressure', unit: 'bar', category: 'fuel' },
  ...
  { id: 'LFbrakeLinePress', label: 'LF brake pressure', unit: 'bar', category: 'tyres' },
  { id: 'RFbrakeLinePress', label: 'RF brake pressure', unit: 'bar', category: 'tyres' },
  { id: 'LRbrakeLinePress', label: 'LR brake pressure', unit: 'bar', category: 'tyres' },
  { id: 'RRbrakeLinePress', label: 'RR brake pressure', unit: 'bar', category: 'tyres' },
  ...
  { id: 'FogLevel', label: 'Fog', unit: '%', category: 'weather' },
  { id: 'Skies', label: 'Sky condition', category: 'weather' },
  { id: 'RelativeHumidity', label: 'Relative humidity', unit: '%', category: 'weather' },
  { id: 'WindDir', label: 'Wind direction', unit: '?', category: 'weather' },
  { id: 'WindVel', label: 'Wind speed', unit: 'm/s', category: 'weather' },
  { id: 'SolarAltitude', label: 'Solar altitude', unit: '?', category: 'weather' },
  { id: 'SolarAzimuth', label: 'Solar azimuth', unit: '?', category: 'weather' },
