...
describe('racecraft question routing', () => {
  ...
  it.each([
    ...
    ['en-US', 'pressure', 'What is tyre pressure?'],
    ['en-US', 'pressure', 'What are tyre pressures?'],
    ['en-US', 'pressure', 'What are the tyre pressures?'],
    ['en-US', 'pressure', 'What are the pressures of the tyres?'],
    ['en-US', 'pressure', 'Current tyre pressure'],
    ...
    ['pt-BR', 'pressure', 'Quais são as pressões atuais dos pneus?'],
    ...
    ['es', 'pressure', '¿Cuáles son las presiones actuales de los neumáticos?'],
    ...
    ['fr', 'pressure', 'Quelles sont les pressions actuelles des pneus ?'],
