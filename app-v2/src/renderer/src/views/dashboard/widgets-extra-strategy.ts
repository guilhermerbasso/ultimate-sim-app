...
export const EXTRA_STRATEGY_VARIANTS: WidgetVariant[] = [
  ...
  nx('x4-standings-tower12', 'Standings · tower 12', 'standings', 380, 560, 'Position/Standings', 'table', undefined, { radius: 12, fontSize: 14, tableColumns: ['pos', 'number', 'name', 'gap', 'laps'], tableMaxRows: 12, showHeader: true, highlightPlayer: true }, ['standings', 'tower', 'endurance']),
