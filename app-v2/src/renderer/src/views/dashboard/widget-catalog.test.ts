...
describe('rich-overlay catalog identity contract', () => {
  ...
  // Revised from 865 to 866 by the RaceCon RC-03 full-frame preset.
  // Revised from 866 to 867 by the RaceCon RC-06 full-frame preset.
...
describe('catalog — curated widgets sectioned by hardware cluster', () => {
  ...
  it("the 'Full-Frame Dashboards' cluster is non-empty (the overlay presets)", () => {
    ...
    // Intentional manifest revision: 15 to 16 by the RaceCon RC-03 full-frame preset.
    // Intentional manifest revision: 16 to 17 by the RaceCon RC-06 full-frame preset.
