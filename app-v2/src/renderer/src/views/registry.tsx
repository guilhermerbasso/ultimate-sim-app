...
export const viewRegistry: ViewDef[] = [
  ...
  { id: 'accessibility-cues', group: 'App', label: 'Accessibility Cues', eyebrow: 'Multimodal', description: 'Semantic caption, audio, symbol, LED, and haptic cue profiles.', shortcut: '0X', Component: AccessibilityCuesView },
