...
export const viewRegistry: ViewDef[] = [
  ...
  { id: 'setup-experiment', group: 'Sim Racing', label: 'Setup Experiment', eyebrow: 'A-B-A', description: 'Local one-variable setup experiments with comparability gates, uncertainty, and abstention.', shortcut: 'TE', Component: SetupExperimentView },
