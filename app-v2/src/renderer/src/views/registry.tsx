...
export const viewRegistry: ViewDef[] = [
  ...
  { id: 'raceops-blueprints', group: 'Sim Racing', label: 'RaceOps Blueprints', eyebrow: 'Declarative', description: 'Signed blueprint manifests, constrained dry-runs, compatibility evidence, and rollback.', shortcut: 'TO', Component: RaceOpsBlueprintsView },
