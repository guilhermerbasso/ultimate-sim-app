...
export const viewRegistry: ViewDef[] = [
  ...
  { id: 'fuel', group: 'Sim Racing', label: 'Fuel', eyebrow: 'Estratégia', description: 'Cálculo de combustível e estratégia.', shortcut: 'T4', Component: FuelStrategyView },
  { id: 'tire', group: 'Sim Racing', label: 'Tires', eyebrow: 'Estratégia', description: 'Tire wear, per-lap rate, and pit window.', shortcut: 'TC', Component: TireStrategyView },
  { id: 'search', group: 'Sim Racing', label: 'Busca Semântica', eyebrow: 'IA local', description: 'Meaning-based search across setups, ghosts, notes, and findings; keyword fallback.', shortcut: 'TS', Component: SemanticSearchView },
  ...
  { id: 'engineer', group: 'Sim Racing', label: 'AI Engineer', eyebrow: 'LLM local', description: 'Engenheiro de corrida com IA local (texto): pergunte sobre combustível, pneus, gaps e estratégia. Inclui o Voice Spotter (avisos falados).', shortcut: 'TG', Component: EngineerView },
  ...
  { id: 'coach', group: 'Sim Racing', label: 'Coach IA', eyebrow: 'IA local', description: 'Coach de pilotagem + análise de laps: achados por curva, mapa da pista e ajustes de setup sugeridos.', shortcut: 'T6', Component: CoachView },
  { id: 'strategy', group: 'Sim Racing', label: 'Estratégia', eyebrow: 'Predictive', description: 'Janela de pit, margem de combustível, undercut e clipes de incidentes.', shortcut: 'TH', Component: StrategyView },
  { id: 'dashboard-builder', group: 'Sim Racing', label: 'AI Dashboard', eyebrow: 'LLM local', description: 'Monte dashboards descrevendo em texto; modo adaptativo por fase da sessão.', shortcut: 'TI', Component: DashboardBuilderView },
  { id: 'dashboard-adaptive', group: 'Sim Racing', label: 'Adaptive Dashboard', eyebrow: 'Live', description: 'Painel único que se reorganiza sozinho por fase da sessão e momento da volta.', shortcut: 'TN', Component: AdaptiveDashboardView },
  { id: 'biometrics', group: 'Sim Racing', label: 'Biometrics', eyebrow: 'HR/AR', description: 'Frequência cardíaca, estresse × ritmo e AR HUD.', shortcut: 'TJ', Component: BiometricsView },
  ...
  { id: 'haptics-zonal', group: 'Sim Racing', label: 'Tátil Zonal', eyebrow: 'Zones', description: 'Eventos→zonas (banco/pedais/volante) + yesulador visual.', shortcut: 'TL', Component: HapticsZonalView },
  { id: 'spotter-3d', group: 'Sim Racing', label: '3D Spotter', eyebrow: 'Áudio espacial', description: 'Cues HRTF posicionais de carros próximos.', shortcut: 'TM', Component: Spotter3DView },
  { id: 'devices', group: 'ButtonBox', label: 'Devices', eyebrow: 'Conexão', description: 'Detecção USB/serial e seleção do ButtonBox.', shortcut: '01', Component: DevicesView },
  ...
  { id: 'inputs', group: 'ButtonBox', label: 'Input Monitor', eyebrow: 'Test', description: 'Validação ao vivo via Web Gamepad API.', shortcut: '04', Component: InputMonitorView },
  { id: 'profiles', group: 'ButtonBox', label: 'Profiles', eyebrow: 'Presets', description: 'Save e carregar configurações de corrida.', shortcut: '05', Component: ProfilesView },
