...
export const ICON_OPTIONS: ReadonlyArray<IconOption> = [
  { id: 'power', label: 'Engine / Power', group: 'Sistema' },
  { id: 'engine-warn', label: 'Aviso motor', group: 'Sistema' },
  { id: 'reset', label: 'Reset', group: 'Sistema' },
  { id: 'esc', label: 'ESC', group: 'Sistema' },
  { id: 'mark', label: 'Marcar volta', group: 'Sistema' },
  { id: 'delta', label: 'Delta', group: 'Sistema' },
  { id: 'settings', label: 'Configurações', group: 'Sistema' },
  { id: 'fuel', label: 'Combustível', group: 'Pit / Fuel' },
  { id: 'fuel-alarm', label: 'Alarme combustível', group: 'Pit / Fuel' },
  ...
  { id: 'tyre', label: 'Pneu', group: 'Pneus / Setup' },
  { id: 'brake-bias', label: 'Brake bias', group: 'Pneus / Setup' },
  { id: 'wing', label: 'Asa / Downforce', group: 'Pneus / Setup' },
  { id: 'headlight', label: 'Farol', group: 'Luzes / Clima' },
  { id: 'highbeam', label: 'Farol alto', group: 'Luzes / Clima' },
  { id: 'wiper', label: 'Limpador', group: 'Luzes / Clima' },
  { id: 'rain', label: 'Chuva', group: 'Luzes / Clima' },
  { id: 'wet', label: 'Molhado', group: 'Luzes / Clima' },
  { id: 'cold', label: 'Frio', group: 'Luzes / Clima' },
  { id: 'radio', label: 'Rádio', group: 'Rádio / Áudio' },
  { id: 'mic', label: 'Microfone', group: 'Rádio / Áudio' },
  { id: 'mic-mute', label: 'Mic mudo', group: 'Rádio / Áudio' },
  { id: 'volume-up', label: 'Volume +', group: 'Rádio / Áudio' },
  { id: 'volume-down', label: 'Volume −', group: 'Rádio / Áudio' },
  { id: 'mute', label: 'Mudo', group: 'Rádio / Áudio' },
  { id: 'camera', label: 'Câmera', group: 'Câmera / Replay' },
  { id: 'camera-next', label: 'Câmera +', group: 'Câmera / Replay' },
  { id: 'camera-prev', label: 'Câmera −', group: 'Câmera / Replay' },
  { id: 'replay', label: 'Replay', group: 'Câmera / Replay' },
  { id: 'monitor', label: 'Black box', group: 'Câmera / Replay' },
  { id: 'flag', label: 'Bandeira', group: 'Flags / Marshal' },
  { id: 'yellow-flag', label: 'Bandeira amarela', group: 'Flags / Marshal' },
  { id: 'pass-left', label: 'Passar à esquerda', group: 'Flags / Marshal' },
  { id: 'pass-right', label: 'Passar à direita', group: 'Flags / Marshal' },
  { id: 'horn', label: 'Buzina', group: 'Flags / Marshal' },
  ...
  { id: 'map', label: 'Mapa', group: 'Dash / Overlay' },
